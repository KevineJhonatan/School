...
namespace School.Infrastructure
{
    public class SchoolContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SysParamValue>().HasData(new SysParamValue { Id = 24, Code = Error.INVALID_LOGIN_PASSWORD_ERROR_CODE.ToString(), ShortText1 = "Credentials", LongText1 = "Invalid Login or Password. Or the user may be disabled.", SysParamId = 4, CreatedAt = createdDate, CreatedBy = 1 });
            ...
            modelBuilder.Entity<SysParamValue>().HasData(new SysParamValue { Id = 41, Code = Error.INEXISTING_SCHOOL_ERROR_CODE.ToString(), ShortText1 = "SchoolID", LongText1 = "The specified school does not exist or disabled.", SysParamId = 4, CreatedAt = createdDate, CreatedBy = 1 });
            ...
            modelBuilder.Entity<SysParamValue>().HasData(new SysParamValue { Id = 47, Code = Error.INVALID_CLASS_NAME_ERROR_CODE.ToString(), ShortText1 = "ClassName", LongText1 = $"The class name is mandatory.", SysParamId = 4, CreatedAt = createdDate, CreatedBy = 1 });
            modelBuilder.Entity<SysParamValue>().HasData(new SysParamValue { Id = 48, Code = Error.INEXISTING_LEVEL_ERROR_CODE.ToString(), ShortText1 = "Level", LongText1 = $"The specified level does not exist or disabled.", SysParamId = 4, CreatedAt = createdDate, CreatedBy = 1 });
